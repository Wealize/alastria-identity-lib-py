...
from alastria_identity.types import UserIdentity, BasicTransaction
...
class UserIdentityService:
    ...
    def add_transaction(self, transaction: BasicTransaction) -> None:
    ...
    def get_signed_transaction_from_anonymous(self, transaction: BasicTransaction) -> HexBytes:
        user_transaction = self.update_transaction_with_user_data(transaction)
        return self.sign_transaction(user_transaction)

    def update_transaction_with_user_data(self, transaction: BasicTransaction) -> BasicTransaction:
